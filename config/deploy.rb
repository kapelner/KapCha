...
set :user, "robertsimmons"
set :password, "adkdacsl"
...
set :db_password, "G294cV2d"

after "deploy:restart", "adkdacsl_custom"
task :adkdacsl_custom, :roles => :app, :except => {:no_release => true, :no_symlink => true} do
